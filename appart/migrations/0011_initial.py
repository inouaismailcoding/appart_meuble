...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('appart', '0010_remove_address_city_remove_address_country_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='appart.property', verbose_name='Type de propriété')),
            ],
        ),
        migrations.CreateModel(
            name='Address',
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appart.country', verbose_name='Pays')),
                ('property', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='appart.property', verbose_name='Type de propriété')),
            ],
        ),
    ]
